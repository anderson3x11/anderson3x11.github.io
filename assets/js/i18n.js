...
(function () {
  var DICT = {
    en: {
      ...
      "projects.nooks.cat": "Web app · Collaborative map",
      "projects.nooks.desc": "A crowdsourced map of unusual places, the kind no guidebook lists. The map sends its viewport to the API, which turns it into a PostGIS polygon query, and the submission form flags a place already posted nearby before a duplicate is ever created.",
    ...
    fr: {
      ...
      "skills.git": "Gestion de versions",
      ...
      "projects.nooks.cat": "App web · Carte collaborative",
      "projects.nooks.desc": "Une carte collaborative de lieux insolites, ceux qu'aucun guide ne référence. La carte envoie son cadrage à l'API qui le transforme en requête polygonale PostGIS, et le formulaire signale un lieu déjà posté à proximité avant même qu'un doublon existe.",
